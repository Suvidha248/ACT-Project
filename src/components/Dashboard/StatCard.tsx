...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-3 group-hover:opacity-5 transition-opacity duration-300`}
      />
          ...
          <div>
            ...
            {trend && (
              ...
              >
                ...
                {isTime ? "faster" : "vs last week"}
              </motion.p>
            )}
          </div>

          <motion.div
            className={`relative p-4 rounded-2xl bg-gradient-to-br ${gradient} ${
